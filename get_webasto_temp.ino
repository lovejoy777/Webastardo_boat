...
//When flame sensor enabled, use Exhaust pin as a room temp sensor (I'm using a 100k thermistor with 100k bias resistor).
THERMISTOR thermistor(exhaust_temp_pin,        // Analog pin 5
...
THERMISTOR thermistor(exhaust_temp_pin,        // Analog pin 5
                      ...
                      100000);         // Value of the series resistor.
#endif
THERMISTOR thermistor2(water_temp_pin,        // Analog pin 3
                       100000,          // Nominal resistance at 25 ºC.
